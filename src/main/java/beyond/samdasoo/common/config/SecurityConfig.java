...
//                        .requestMatchers("/api/**", "/swagger-ui/**", "/v3/api-docs/**").permitAll() // 테스트용
                                ...
                                .requestMatchers("/swagger-ui/**", "/v3/api-docs/**", "/test/**", "/api/users/login", "/api/users/join",
                                        "/api/users/reissue", "/api/users/email/**", "/api/admin/targetsales/status/**","/api/users/reset-password-request","/api/users/reset-password","api/report/**").permitAll()
