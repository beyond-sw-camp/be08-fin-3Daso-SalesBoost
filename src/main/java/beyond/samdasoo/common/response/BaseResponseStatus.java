...
public enum BaseResponseStatus {
  ...
  //  JWT_EXPIRED_ACCESS_TOKEN(false, HttpStatus.UNAUTHORIZED.value(), "만료된 액세스 토큰입니다"),
    ...
    EMAIL_NOT_EXIST(false, HttpStatus.BAD_REQUEST.value(), "등록되지 않은 이메일입니다"),
    ...
    FAIL_UPDATE_PASSWORD(false,HttpStatus.INTERNAL_SERVER_ERROR.value(), "비밀번호 변경에 실패했습니다."),
    FAIL_EXPIRE_TIME(false,HttpStatus.INTERNAL_SERVER_ERROR.value(), "인증시간 만료로 비밀번호 변경에 실패했습니다"),
